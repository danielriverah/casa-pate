  ...
  return (
    <header className="navbar">
      <div className="nav-content">
        ...
        <NavLink to="/historia" className={({ isActive }) => isActive ? 'nav-link active' : 'nav-link'}>Nuestra Historia</NavLink>
        <NavLink to="/por_que" className={({ isActive }) => isActive ? 'nav-link active' : 'nav-link'}>¿Por qué Casa Pate?</NavLink>
        ...
        <NavLink to="/haz__tu_pedido" className={({ isActive }) => isActive ? 'nav-link active' : 'nav-link'}>Haz tu pedido</NavLink>
